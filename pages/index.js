...
const TRUMP_SAID = [
  ...
  },
  {
    ...
    reality: 'US forces struck 50+ military targets on Kharg Island and deliberately avoided oil infrastructure. VP Vance described the strikes as "not a change in strategy." Iran\'s military dismissed the rhetoric as "delusional" and "baseless." Trump\'s 8pm ET deadline expired; the Strait of Hormuz remained closed. Day 39.',
  }
];
...
const DAILY_ASSESSMENTS = [
  ...
  { day: 39, date: 'Apr 7', x: 93, y: 1.5,
    xNote: '93/100: Floor is 59. Event push of +34. Kharg Island struck directly — 50+ military targets, first kinetic engagement with Iran\'s oil export hub. WTI $115.8/bbl (highest since April 2008). IRGC formally removes "good neighborliness" restraint toward GCC states: all US forward bases in Bahrain, Qatar, UAE and Kuwait are now inside the declared Iranian threat envelope. That is a structural expansion of the theater, not a rhetorical gesture. Score jumps on Kharg kinetics + oil price + IRGC GCC statement; oil infrastructure was spared this round but the ceiling condition ($150 sustained WTI) is now in sight.',
    yNote: 'TLM Assessment Day 39: 1.5/10. Hold with downside bias. Iran\'s 10-point permanent peace proposal via Pakistan is the only data point arguing against a further Y move down — it signals Tehran has a negotiated endgame in view. But the proposal paired with a ceasefire rejection reads as an opening position designed to be unacceptable. The IRGC removing GCC restraint is the operationally meaningful signal: the number of parties who need to sign off on any resolution just increased, and the physical infrastructure of US regional power projection is now explicitly in scope.' }
];
