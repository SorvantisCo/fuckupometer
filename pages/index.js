...
{ date: 'Mar 30', tier: 'critical', label: 'Trump tells the Financial Times: "Maybe we take Kharg Island, maybe we don\'t. We have a lot of options." Then: "It would also mean we had to be there [on Kharg Island] for a while." Brent rises 3.5% to $116+ on the statement — market repricing a ground invasion premium. Iran has been reinforcing Kharg for weeks. Australian Strategic Policy Institute: "The Iranians can probably sit back and attack Americans on Kharg Island, and casualties will mount up." Trump is publicly weighing a ground invasion of Iran\'s primary oil export hub in the same interview where he claims a deal is imminent. Day 31.' },
  ...
  { date: 'Apr 17', tier: 'today', label: 'Iran FM Araghchi declares Strait of Hormuz "completely open" for commercial vessels for remaining ceasefire period, linked to Lebanon truce. WTI drops to ~$84 (-10%). Stocks surge. Day 49.' },
  { date: 'Apr 17', tier: 'today', label: 'Trump: US blockade "will remain in full force" until peace deal complete. Second Islamabad round expected this weekend. Paris summit: Macron and Starmer host multinational Hormuz reopening talks. Day 49.' },
  { date: 'Apr 17', tier: 'today', label: 'Shipping companies cautious: only handful of ships transit Hormuz despite declaration. Outstanding questions on enforcement. IAEA Grossi: nuclear verification must anchor any deal. Ceasefire expires April 21. Day 49.' },
];
